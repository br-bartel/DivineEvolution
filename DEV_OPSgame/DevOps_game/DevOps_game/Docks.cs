        ...
        public override List<string> chooseText(string input)
        {
            ...
            if (Game.currentState.cycle == 1)
            {
                ...
                else
                {
                    ...
                    validInputs.Add("wallet", "A simple leather wallet. Contains your Mage License - 2nd Class, identification papers, and a coupon for a half priced mead from your local tavern.");
                    validInputs.Add("purse", "A simple pouch, containing a single gold piece, a couple silver pieces, and a handful of copper pieces.");
                    validInputs.Add("watch", "The silver pocket watch that your father got you upon your graduation from University. It has an engraving on the back - \"A wizard is never late, nor is he early, he arrives precisely when he means to.\" - your father’s favorite quote from the old bard’s tale Rings of the Lord.");
                    validInputs.Add("parchment", "You unfold the parchment, trying to make sense of what it says around the damp spots that has caused the ink to bleed. All you can really puzzle out is that it’s dated the 16th of Donnestag. Well, that makes sense, given that your holiday was supposed to be the 15th through the 17th. You figure today must be the 17th or, if you’re particularly unlucky, the 18th. Your boss is the understanding sort, right?");
